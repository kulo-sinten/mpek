...
curl -sS https://raw.githubusercontent.com/kulo-sinten/mpek/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/kulo-sinten/mpek/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
